...
l_folder = "D:\Research\Music Generation\Text to Music\musicldm.github.io/files\similarity"
subfolders = os.listdir(l_folder)
for folder in subfolders:
    ...
    for f in files:
        ...
        fig.tight_layout()
        fig.savefig(os.path.join(l_folder, folder,"".join(f.split(".")[:-1]) + '.png'))